...
#load piece images
pieces = {'p': pygame.image.load(PIECE_PATH + 'blackp.png').convert(),
...
def update(scrn,board):
    ...
    for i in range(64):
        ...
        if piece == None:
            ...
            scrn.blit(pieces[str(piece)],((i%8)*80,560-(i//8)*80))
    
    for i in range(7):
        i=i+1
        pygame.draw.line(scrn,WHITE,(0,i*80),(640,i*80))
        pygame.draw.line(scrn,WHITE,(i*80,0),(i*80,640))
    ...
    while (status):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                square = (math.floor(pos[0]/80),math.floor(pos[1]/80))
                    ...
                    if piece == None:
                        ...
                        for m in all_moves:
                            if m.from_square == index:
                                ...
                                pygame.draw.rect(scrn,BLUE,pygame.Rect(TX1,TY1,80,80),5)
